...
primaryExpr returns [float value]
...
statement: Identifier '=' arith_expression ';'
 { memory.put($Identifier.text, new Integer($arith_expression.value)); if (TRACEON) System.out.println("final value: " + $arith_expression.value); }
